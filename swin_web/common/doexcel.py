#!/user/bin/python
# -*- coding:utf-8 -*-
import requests, xlrd, time, sys,xlwt,os
...
def fenxiexcel(case_list):
    ...
    worksheet.write(1,4,success_wechat_pens)
    worksheet.write(1,5,fail_wechat_pens)
    worksheet.write(1,6,yichang_wechat_pens)
    worksheet.write(1,7,success)
    worksheet.write(1,8,yichangbili)
