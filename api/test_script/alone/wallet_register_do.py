...
def copy_excel(file_path, res_flags, request_urls, responses):
    ...
    name1=time.strftime('%Y%m%d%H%M%S')+"wallet_register_do.xls"
...
if __name__ == '__main__':
    try:
        # filename = sys.argv[1]
        filename=os.path.dirname(os.path.dirname(os.path.dirname(__file__)))+"/cases/alone/"+"wallet_register_do.xls"
    except IndexError, e:
